...
""" According to the elbow method for difining the number of the clusters(k) = 7 (soft DTW) 
Sillouhette score = 0.69469
"""

""".............cluster 0 .........."""

"""
avg_data = [sum(data)/len(data) for data in zip(data_02, data_14, data_16, data_18, data_30, data_31,
                                                data_38, data_45, data_47, data_49)]
...
data_50 = [x / max(data_50) for x in data_50]
...
"""
avg_data = [sum(data)/len(data) for data in zip(data_04, data_05, data_07, data_08, data_11, data_13, data_22, data_26, data_32, data_36, data_40, data_42, data_43)]
avg_data = [x / max(avg_data) for x in avg_data]
...
"""
avg_data = [sum(data)/len(data) for data in zip(data_00, data_03, data_19, data_24, data_44)]
avg_data = [x / max(avg_data) for x in avg_data]
...
""".............cluster 6 .........."""
"""
avg_data = [sum(data)/len(data) for data in zip(data_12, data_25, data_34, data_37, data_46)]
avg_data = [x / max(avg_data) for x in avg_data]
...
""" According to the elbow method for difining the number of the clusters(k) = 7 (DTW)
Sillouhette score = 0.7050
"""


""".............cluster 0 .........."""
"""
avg_data = [sum(data)/len(data) for data in zip(data_02, data_16, data_18,
                                                data_38, data_45, data_47, data_49)]
avg_data = [x / max(avg_data) for x in avg_data]
...
""".............cluster 2 .........."""
"""
avg_data = [sum(data)/len(data) for data in zip(data_06, data_10, data_35)]
avg_data = [x / max(avg_data) for x in avg_data]
data_06 = [x / max(data_06) for x in data_06]
data_10 = [x / max(data_10) for x in data_10]
data_35 = [x / max(data_35) for x in data_35]
...
""".............cluster 4 .........."""
"""
avg_data = [sum(data)/len(data) for data in zip(data_04, data_05, data_07, data_08, data_11,
                                                data_12, data_13, data_22, data_25, data_26, data_32,
                                                data_34, data_36, data_37, data_40, data_42, data_43,
                                                data_46)]
avg_data = [x / max(avg_data) for x in avg_data]
...
"""
avg_data = [sum(data)/len(data) for data in zip(data_00, data_03, data_14, data_19, data_24,
                                                data_26, data_30, data_31, data_44)]
avg_data = [x / max(avg_data) for x in avg_data]
...
"""
avg_data = [sum(data)/len(data) for data in zip(data_17, data_20, data_21, data_28, data_33)]
avg_data = [x / max(avg_data) for x in avg_data]
