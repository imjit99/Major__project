...
""" According to the elbow method for difining the number of the clusters(k) = 5 (soft DTW) 
Sillouhette score = 0.7684468
"""
...
avg_data = [sum(data)/len(data) for data in zip(data_00, data_02, data_03, data_14, data_16, data_18, data_19, data_24, data_26, data_30, data_31, data_38, data_44, data_45, data_47, data_49)]
...
""" According to the elbow method for difining the number of the clusters(k) = 5 (DTW)
Sillouhette score = 0.7684468
"""
...
# for i ,data in zip(range(1,31) ,avg_data):
#     print(f"{i},{data}\n",end="")
